...
function setup() {
  ...
  let inputKey = createInput("xyzzy");
  inputKey.parent(label);
  inputKey.input(() => {
    rebuildWorld(inputKey.value());
  });

  createP("Arrow keys scroll. Clicking makes ripples in the water.").parent("canvas-container");
